...
const features = [
    {
      ...
      description: "Comprehensive student enrollment, profile management, and academic tracking system",
      href: "/features/student-management"
    },
    {
      icon: GraduationCap,
      title: "Academic Management",
      description: "Course scheduling, curriculum planning, and grade management tools",
      href: "/features/academic-management"
    },
    {
        icon: MessageSquare,
        title: "Communication Hub",
        description: "Parent-teacher messaging, announcements, and notifications",
        href: "/features/communication"
    },
    {
        icon: DollarSign,
        title: "Financial Management",
        description: "Complete fee management system with online payments, invoicing and comorehensive financial reporting",
    ...
    },
    {
        ...
        description: "Bus route planning, tracking, and student transportation coordination",
        href: "/features/transport"
    },
    {
        icon: BarChart2,
        title: "Analytics & Reports",
        description: "Performance insights, trends analysis, and data visualization",
        href: "/features/analytics"
    },
    {
        icon: BookOpen,
        title: "Resource Management",
        description: "Book inventory, issue tracking, and digital resource management",
    ...
    },
    {
      ...
      description: "Automated report cards, transcripts, and progress reports",
...
export default function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container max-w-8xl mx-auto flex h-14 items-center justify-between">
